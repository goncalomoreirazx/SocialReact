...
-- A despejar dados para tabela socialreact.friends: ~9 rows (aproximadamente)
INSERT INTO `friends` (`id`, `user_id`, `friend_id`, `created_at`, `status`) VALUES
	...
	(14, 7, 2, '2025-02-25 17:01:31', 'accepted'),
...
-- A despejar dados para tabela socialreact.messages: ~193 rows (aproximadamente)
INSERT INTO `messages` (`id`, `sender_id`, `receiver_id`, `content`, `sent_at`, `is_read`, `reply_to_id`, `image_url`) VALUES
	...
	(205, 2, 7, 'wwww', '2025-03-01 11:43:30', 0, NULL, NULL);
...
-- A despejar dados para tabela socialreact.users: ~16 rows (aproximadamente)
INSERT INTO `users` (`id`, `email`, `username`, `password`, `profile_picture`, `cover_photo`, `birth_date`, `created_at`, `bio`, `last_active`) VALUES
	(2, 'goncalomoreira373@gmail.com', 'SlayerX', '$2b$10$ACW/Nr02B1a13Z.cyCRj5uDLzgv7JOlRCDw/AzB9DzQOClcrdzqs2', 'photo-1739285459123-533357550.JPG', NULL, '1999-10-05', '2024-12-26 18:45:51', 'Sou lindo #CR7 éué 227\r\n', '2025-03-01 12:16:07'),
	...
	(7, 'Exitas@gmail.com', 'ExitasBerg', '$2b$10$mlTK.yCotlPZg1N/BMRIGeZ8hV/UsK7urUVwY4b4UrY.1rXRVHkvC', 'profilePicture-1739283735527-776750777.jfif', NULL, '1996-06-12', '2025-02-11 14:22:15', NULL, '2025-03-01 11:43:37'),
	...
	(16, 'abdousasuke@gmail.com', 'Abdou99', '$2b$10$xxMj25pgF.iBrZfm9sSesuY.y90r61qOoJ.y1.Z6RfBfi3OjCf9n6', 'profilePicture-1739983706327-594632729.jpg', NULL, '1995-03-10', '2025-02-19 16:48:27', NULL, '2025-03-01 11:54:10'),
