    ...
    <form onSubmit={handleSubmit} className="flex items-start space-x-2">
      ...
      <div className="flex-1 min-w-0 relative">
        <textarea
          ...
          className="w-full p-1.5 bg-gray-100 rounded-lg resize-none focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-white transition-all duration-200 text-xs min-h-[28px]"
          rows="1"
        />
      </div>
